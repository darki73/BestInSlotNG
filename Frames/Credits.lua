...
function Credits:Draw(container)
  ...
  scroll:AddChild(header)
  -- urls
  scroll:AddChild(self:CreateUneditableTextbox("https://www.curseforge.com/wow/addons/best-in-slot-ng", "BestInSlotNG on Curse.com"))
  scroll:AddChild(self:CreateUneditableTextbox("https://github.com/darki73/BestInSlotNG", "BestInSlotNG on Github.com"))
  ...
  -- Translation help
  scroll:AddChild(self:CreateUneditableTextbox("https://wow.curseforge.com/projects/bestinslotng/localization", "Want to help translate BestInSlotNG?"))
